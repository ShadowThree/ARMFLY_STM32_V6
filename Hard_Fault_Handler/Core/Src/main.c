...
int main(void)
{
  ...
  MX_USART1_UART_Init();
  /* USER CODE BEGIN 2 */
  HAL_UARTEx_ReceiveToIdle_DMA(&huart1, rxBuf, LEN_UART_RX_BUF);
  HAL_UART_Transmit(&huart1, (const uint8_t*)"Hard Fault demo start...\n", strlen("Hard Fault demo start...\n"), 100);
  /* USER CODE END 2 */
